            ...
            <div>
                <div class="bg-gray-800 rounded-lg p-6 mb-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <?php endif; ?>
                        <a href="ticket.php?subscription_id=<?php echo $subscription['id']; ?>" class="block py-2 px-4 bg-gray-700 hover:bg-gray-600 rounded text-center transition duration-300">
